                    ...
                    <div className="flex h-full flex-1 flex-col space-y-4 p-2">
                      ...
                      <div className="h-36 overflow-hidden duration-700 rounded hover:h-90 hover:duration-800 hover:transition-[height] max-h-max">
                        <div className="w-full max-w-2xl mx-auto relative">
                          ...
                          <div className="absolute pointer-event-none inset-0 top-[6.9%] left-[0.08%] right-[0.08%] bottom-[1.6%] overflow-hidden">
                            <div className="w-full h-full overflow-hidden">
                              <div className="origin-top-left scale-[0.25] w-[400%] h-[400%] bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
