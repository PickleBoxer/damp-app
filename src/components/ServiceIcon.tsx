import ValkeyIcon from '@/assets/valkey';
import TypesenseIcon from '@/assets/typesense';
import MailpitIcon from '@/assets/mailpit';
import MemcachedIcon from '@/assets/memcached';
