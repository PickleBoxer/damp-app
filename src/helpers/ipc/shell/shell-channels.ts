...
export const SHELL_OPEN_TINKER_CHANNEL = 'shell:open-tinker';
export const SHELL_OPEN_URL_CHANNEL = 'shell:open-url';
export const SHELL_GET_SETTINGS_CHANNEL = 'shell:get-settings';
