...
import type { ProjectStorageData, Project } from '../../types/project';
...
class ProjectStorage {
  ...
  private async load(): Promise<void> {
    ...
    console.log(`Loaded project configuration from ${this.storagePath}`);
  }
  ...
  async save(): Promise<void> {
    ...
    console.log(`Saved project configuration to ${this.storagePath}`);
  }
